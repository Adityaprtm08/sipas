...
<html>
    ...
    <table style="width: 100%; text-align: center;">
      <tr>
        <td class="font14"><strong>LAPORAN REKAPITULASI SURAT KELUAR</strong></td>
      </tr>
      <tr>
    ...
    <br>
      ...
      <tr style="border: 1px solid #000000; height: 20px; margin: 8px;">
        ...
        <th style="border: 1px solid #000000; height: 20px; margin: 8px; width: 10%; text-align: center">Tanggal Kirim</th>
        ...
        <th style="border: 1px solid #000000; height: 20px; margin: 8px; width: 14%; text-align: center">Penerima</th>
      ...
      <tr style="border: 1px solid #000000; height: 20px; margin: 8px;">
        ...
        <td style="border: 1px solid #000000; height: 20px; margin: 8px;"><?= $dsk['nomor_surat']; ?></td>
        <td style="border: 1px solid #000000; height: 20px; margin: 8px;"><?= tanggal_default($dsk['tanggal_surat']); ?></td>
        <td style="border: 1px solid #000000; height: 20px; margin: 8px;"><?= tanggal_default($dsk['tanggal_kirim']); ?></td>
        <td style="border: 1px solid #000000; height: 20px; margin: 8px;"><?= $dsk['nomor_agenda']; ?></td>
        <td style="border: 1px solid #000000; height: 20px; margin: 8px;"><?= $dsk['sifat_surat']; ?></td>
        <td style="border: 1px solid #000000; height: 20px; margin: 8px;"><?= $dsk['nama_bagian']; ?></td>
        <td style="border: 1px solid #000000; height: 20px; margin: 8px;"><?= $dsk['penerima']; ?></td>
        <td style="border: 1px solid #000000; height: 20px; margin: 8px;"><?= $dsk['perihal']; ?></td>
      </tr>
      <?php endforeach; ?>
		</table>
    <br>
